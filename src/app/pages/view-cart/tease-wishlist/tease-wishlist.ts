  ...
  template: ` 
    <div appViewPanel class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          <h2 class="text-gray-500 text-sm">Wishlist ({{store.wishlistCount() }}) Items saved for later </h2>
      ...
      <div class="flex items-center gap-3">
        ...
        <button matButton="filled" class="flex item-center gap-2" (click)="store.addAllWishlistToCart()">
